...
\begin{abstract}
%\boldmath
The olfactory sense is strongly related with memory and emotional processes. Studies on the effects of odor perception from brain activity have been conducted by using different neuro-imaging techniques. 
In this paper, we analyse electroencephalography (EEG) of 23 subjects during perceiving pleasant and unpleasant odor stimuli. We describe the construction of brain functional connectivity networks measured by most commonly used models. We discuss the network-based features of functional connectivity, as well as design classifiers by applying different functional connectivity network features. Finally, we show that the brain can be seen as a nonlinear small-world network, and by extracting appropriate features we manage to classify pleasant and unpleasant olfactory perceptions with a significantly non-random average Kappa value of $0.11 \pm 0.16$.
\end{abstract}
